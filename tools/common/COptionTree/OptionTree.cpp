...
void COptionTree::InitGlobalResources()
{
    ...
    // Normal font
    m_fNormalFont = new CFont;
    m_fNormalFont->CreateFont(12, // Height
        0, // Width
        0, // Escapement
        0, // Orientation
        FW_NORMAL, // Weight
    ...
    // Bold font
    m_fBoldFont = new CFont;
    m_fBoldFont->CreateFont(12, // Height
        0, // Width
        0, // Escapement
        0, // Orientation
        FW_BOLD, // Weight
...
void COptionTree::Delete(COptionTreeItem *otiItem)
{
	...
	if (otiItem != &m_otiRoot)
	{
		...
		//delete otiItem;
        switch( otiItem->GetItemType() )
        {
        case OT_ITEM_CHECKBOX:
            delete (COptionTreeItemCheckBox*)otiItem;
            break;
        case OT_ITEM_COMBOBOX:
            delete (COptionTreeItemComboBox*)otiItem;
            break;
        case OT_ITEM_EDIT:
            delete (COptionTreeItemEdit*)otiItem;
            break;
        case OT_ITEM_RADIO:
            delete (COptionTreeItemRadio*)otiItem;
            break;
        default:
            delete otiItem;
        }
